...
class _ListeningState extends State<Listening> {
  ...
  // Search box widget with dynamic padding
  ...
  // Method to display a single book element with dynamic image size
  Widget _makeBookEl(Book book, BuildContext context) {
    // Get the screen width to adjust image size dynamically
    double screenWidth = MediaQuery
        .of(context)
        .size
        .width;
    ...
    return GestureDetector(
      ...
      onTap: () {
        ...
        Get.to(() => ListeningViewer(pdfPath: fullPdfPath));
      },
  ...
  // Grid to display the books with dynamic spacing
