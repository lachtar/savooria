              ...
              children: [
                ...
                Align(
                    ...
                    child: Column(
                      ...
                      children: [
                        const Text('No Rules Rules', style: TextStyle(fontSize: 23.0, fontWeight: FontWeight.w800, color: Colors.black)),
                        const SizedBox(height: 10.0),
                        const Text('Reed Hastings / Erin Meyer', style: TextStyle(fontSize: 14.0, fontWeight: FontWeight.w500, color: Colors.grey)),
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            const Text('4.5', style: TextStyle(fontSize: 13.0, fontWeight: FontWeight.w700, color: Colors.grey))
                          ],
                        ),
