...
class _ChattingPageState extends State<ChattingPage> {
  ...
  void initState() {
    ...
    fullPdfPath = "https://savooria.com/$fileeepath";
    print("Full PDF Path: $fullPdfPath");
    print("Book Title: $bookTitle");
  }

  Future<void> _sendMessage(String text, String fullPdfPath) async {
    if (text.isNotEmpty) {
      setState(() {
            ...
            child: Row(
              children: [
                ...
                IconButton(
                  ...
                  onPressed: () => _sendMessage(_controller.text, fullPdfPath),
                ),
              ],
            ),
          ),
